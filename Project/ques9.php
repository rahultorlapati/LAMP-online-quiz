        ...
        <tr>
            <td>
                    ...
                    <?php 
                            ...
                            $query = "SELECT question, optiona, optionb, optionc, optiond, keyoption from question where id=9";
                    ...
                    <p class="padding"><input type="next" value="Next question" onclick="window.location.href='ques10.php'" readonly></p>
